...
const FeatureList = [
  {
    ...
    image: require('@site/static/img/WizardWave.png').default,
    description: (
      <>
  ...
  },
  {
    ...
    image: require('@site/static/img/WizardSmileOpen.png').default,
    description: (
      <>
  ...
  },
  {
    ...
    image: require('@site/static/img/WizardSmileClosed.png').default,
    description: (
      <>
  ...
  // Add more features for the second row
  {
    ...
    image: require('@site/static/img/WizardHeart.png').default,
    description: (
      <>
  ...
  },
  {
    ...
    image: require('@site/static/img/WizardNote.png').default,
    description: (
      <>
